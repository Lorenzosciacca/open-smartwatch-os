...
class OswHal {
  public:
    ...
    bool btnDoublePress(Button btn);
  ...
  private:
    ...
    bool double_timeOut[NUM_BUTTONS];
    unsigned long _btnDoubleMillis[NUM_BUTTONS];
    bool _btnDoublePress[NUM_BUTTONS];
    uint8_t _detectDoubleCount[NUM_BUTTONS];
